...
\begin{frame}
  ...
  \centering
  \includegraphics[width=0.7\linewidth]{media/cft-vir-lego.png}
  \includegraphics[width=0.9\linewidth]{media/vir-primary.pdf}
\end{frame}
...
\begin{frame}
  ...
  \framesubtitle{The building blocks of a Conformal Field Theory}
  \centering
  \includegraphics[width=0.7\linewidth]{media/cft-w-lego.png}
  \includegraphics[width=0.9\linewidth]{media/w-primary.pdf}
\end{frame}
